...
(() => {
    ...
    function validateAcceptedOrdersContract(contract) {
        if (!contract.mainCell || !               && labels[5] === "czynnosc";
        }) || null;
    }
    ...
    function consumePendingNativeDialog() {
        ...
        const root = document.documentElement;
        co[0].dataset.taOrderSearchRole = "label";
    ...
    function submitApprovalWithoutNativeModal(approvalForm, selectedCount, proxyButton) {
        ...
        const frame = document.createElement("iframalForm, selectedCount, proxyButton);
                    return;
                }
    ...
    function mountOrderAttachmentPopup() {
        ...
        deleteControls.forEach(control => {
            ...
            if (previewCell) {
                ...
                const previewN          notice = document.createElement("div");
  ...
  ;
        ...
        const prepareRecord = () => {
            ...
            return preparePromise;            placeholder="${kind === "driver" ? "Szukaj i wybierz kierowcę…" : "Szukaj i wybierz ciągnik lub naczepę…"}">
    ...
    async function fetchOfferLoadingPlaces(sourceForm) {
        ...
        const responseUrl = new URL(response.url || action.href, location.href) new DOMParser().parseFromString(html, "text/html");
    ...
    function installNavigationShield() {
        ...
        document.addEventListener("submit", event => {
            ...
            co-intranet-page-order-workflow [data-ta-order-workflow-form="true"] input[type="date"],
